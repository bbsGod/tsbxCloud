<template style="background: #cccccc">
  ...
  <div :yname="yname" :ytype="ytype" :title="title" :xAxisData="xAxisData" :yAxisData1="yAxisData1"
       :yAxisData2="yAxisData2" :id="id" :legend="legend"
       :style="{width:width,height:height,background:background,margin:margin}">
  </div>
