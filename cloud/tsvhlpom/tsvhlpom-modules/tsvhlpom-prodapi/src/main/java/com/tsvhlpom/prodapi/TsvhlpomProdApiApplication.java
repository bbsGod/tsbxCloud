...
public class TsvhlpomProdApiApplication {

    public static void main(String[] args) {
        SpringApplication.run(TsvhlpomProdApiApplication.class, args);
        System.out.println("车险外部服务系统启动成功");
    }
