...
public class CompareUtils {
        ...
        try {
            ...
            if (obj1.getClass() == obj2.getClass()) {
                ...
                for (PropertyDescriptor pd : pds) {
                    ...
                    if (null == o1 || null == o2){
                        setResult(claz.getSimpleName(),o1, o2, name, label, list);
                        continue;
                    }
    ...
    private static void setResult(String table_name,Object o1, Object o2,String name,String label, List<ComparisonResult> list){
        Object ot = null;
        String r1 = null,r2 = null;
        ...
        //result.setTable_name(table_name);
        result.setKey(name);
