...
/**
 * 申请单险别系数对象 web_app_cvrg_prm_coef
 *
 * @author ruoyi
 * @date 2022-06-07
 */
public class WebAppCvrgPrmCoef extends BaseEntity
{
...
机关、企业 */
    ...
    /** 投保时为投保单的PKID，批改申请时如非新增记录则为原投保单的PKID，如为新增记录则为批改申请单的PKID */
    ...
    /** 车主性别 */
    @Excel(name = "车主性别")
    @AnjiDescription("cVhlowerSex")
    private String cVhlowerSex;

    /** 车主性别数值 */
    @Excel(name = "车主性别数值")
    @AnjiDescription("nVhlowerSex")
    private Long nVhlowerSex;

    /** 车主年龄 */
    @Excel(name = "车主年龄")
    @AnjiDescription("cVhlowerAge")
    private String cVhlowerAge;

    /** 车主年龄数值 */
    @Excel(name = "车主年龄数值")
    @AnjiDescription("nVhlowerAge")
    private Long nVhlowerAge;

    /** 车主驾龄 */
    @Excel(name = "车主驾龄")
    @AnjiDescription("cVhlowerDrvage")
    private String cVhlowerDrvage;

    /** 车主驾龄数值 */
    @Excel(name = "车主驾龄数值")
    @AnjiDescription("nVhlowerDrvage")
    private Long nVhlowerDrvage;

    /** 不确定浮动因子 */
    @Excel(name = "不确定浮动因子")
    @AnjiDescription("nUnsureCoef")
    private Long nUnsureCoef;
    ...
    public void setcVhlowerSex(String cVhlowerSex)
    {
        this.cVhlowerSex = cVhlowerSex;
    }

    public String getcVhlowerSex()
    {
        return cVhlowerSex;
    }
    public void setnVhlowerSex(Long nVhlowerSex)
    {
        this.nVhlowerSex = nVhlowerSex;
    }

    public Long getnVhlowerSex()
    {
        return nVhlowerSex;
    }
    public void setcVhlowerAge(String cVhlowerAge)
    {
        this.cVhlowerAge = cVhlowerAge;
    }

    public String getcVhlowerAge()
    {
        return cVhlowerAge;
    }
    public void setnVhlowerAge(Long nVhlowerAge)
    {
        this.nVhlowerAge = nVhlowerAge;
    }

    public Long getnVhlowerAge()
    {
        return nVhlowerAge;
    }
    public void setcVhlowerDrvage(String cVhlowerDrvage)
    {
        this.cVhlowerDrvage = cVhlowerDrvage;
    }

    public String getcVhlowerDrvage()
    {
        return cVhlowerDrvage;
    }
    public void setnVhlowerDrvage(Long nVhlowerDrvage)
    {
        this.nVhlowerDrvage = nVhlowerDrvage;
    }

    public Long getnVhlowerDrvage()
    {
        return nVhlowerDrvage;
    }
    public void setnUnsureCoef(Long nUnsureCoef)
    {
        this.nUnsureCoef = nUnsureCoef;
    }

    public Long getnUnsureCoef()
    {
        return nUnsureCoef;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("cVhlowerSex", getcVhlowerSex())
            .append("nVhlowerSex", getnVhlowerSex())
            .append("cVhlowerAge", getcVhlowerAge())
            .append("nVhlowerAge", getnVhlowerAge())
            .append("cVhlowerDrvage", getcVhlowerDrvage())
            .append("nVhlowerDrvage", getnVhlowerDrvage())
            .append("nUnsureCoef", getnUnsureCoef())
            .toString();
    }
}
